...
class ApprovalWaitingScreen extends StatelessWidget {
  ApprovalWaitingScreen({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Get.find<AuthController>().userModel.partnerApplicationId != null &&
      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        return SmartRefresher(
          ...
          enablePullDown: true,
          onRefresh: () => onRefresh(authController),
          child: Column(
            children: [
              Expanded(
  ...
  onRefresh(AuthController authController) async {
    await authController.getProfile(userID: authController.userModel.id);
    if (authController.userModel.partnerApplicationId.status == "Approved") {
      CustomDialog(
        buttonText: "OK",
