                    ...
                    child: Padding(
                      ...
                      child: Column(children: [
                        ...
                        MyTextField(
                            ...
                            controller:
                                authController.workinglocationController,
                        ...
                        Container(
                          ...
                          child: DropdownSearch<String>(
                            ...
                            items:
                                authController.allStateDistrictModel.stateList,
                            ...
                            onChanged: ((value) {
                              authController.setDistrictList(value);
                            }),
                            selectedItem: authController.selectedState != null
                                ? authController.selectedState
                                : '',
                          ),
                        ),
                        SizedBox(
                        ...
                        Container(
                          ...
                          child: DropdownSearch<String>(
                            ...
                            items: authController.districtList != null
                                ? authController.districtList
                                : [],
                            dropdownDecoratorProps: DropDownDecoratorProps(
                              dropdownSearchDecoration: InputDecoration(
                                  labelText: "District",
                            ...
                            onChanged: ((value) {
                              authController.setDistrict(value);
                            }),
                            selectedItem:
                                authController.selectedDistrict != null
                                    ? authController.selectedDistrict
                                    : '',
                          ),
                        ),
                        SizedBox(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: MyTextField(
                                  hintText: 'User Name',
                                  isEnabled: fromSignIn,
                                  isError: authController.isUserNameAvailable ==
                                          1
                                      ? false
                            ...
                            ? Column(
                                children: [
                                  ...
                                  MyTextField(
                                      ...
                                      inputAction: TextInputAction.next,
                                      nextFocus:
                                          authController.experienceFocusNode),
                                  SizedBox(
                                    height: Dimensions.PADDING_SIZE_SMALL,
                                  ),
                                ],
                        ...
                        Row(
                          children: [
                            Expanded(
                              ...
                              activeColor: Theme.of(context).primaryColor,
                              dense: false,
                              onChanged: (bool value) => authController
                                  .setMechanicStatus(status: value),
                            )),
                            SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                            Expanded(
                                child: CheckboxListTile(
                              ...
                              dense: false,
                              onChanged: (bool value) => authController
                                  .setQuickHelphStatus(status: value),
                            )),
                          ],
                        ),
                        SizedBox(
                        ...
                        Row(children: [
                          Expanded(
                            ...
                            groupValue: authController.isShiftTime
                                ? 'shift_based'
                                : 'any',
                            value: 'any',
                            contentPadding: EdgeInsets.zero,
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemCount: fromSignIn
                                          ? authController
                                                      .pickedImageList.length >
                                                  0
                                              ? authController.pickedImageList
                                                          .length >
                                                      2
                                                  ? 2
                                                  : authController
                                      ...
                                      itemBuilder: ((context, index) {
                                        if (fromSignIn) {
                                          if (index == 0) {
                                            ...
                                            return imageHolder(authController,
                                                context, index - 1);
                                          }
                                        } else {
                                          if (authController
